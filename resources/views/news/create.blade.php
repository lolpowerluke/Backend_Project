                    ...
                    <form method="POST" action="{{ route('news.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="row mb-3">
                              ...
                              <div class="col-md-6">
                                  <input type="file" name="image" id="image" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ old('image') }}" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                              <textarea name="short_desc" id="short_desc" class="form-control" required>{{ old('short_desc') }}</textarea>
                              @error('short_desc')
                                  <span class="invalid-feedback" role="alert">
                                      <strong>{{ $message }}</strong>
                                  </span>
